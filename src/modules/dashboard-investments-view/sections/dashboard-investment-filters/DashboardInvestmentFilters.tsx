      ...
      <section data-testid="dashboard-investment-filters">
        <div className="grid grid-cols-2 w-full justify-between bg-[#f1f2f3]">
          <div
            ...
            className="col-span-1 flex justify-center items-center cursor-pointer bg-[#A7AEBF]"
          >
          ...
          <div className="col-span-1 flex justify-center items-center cursor-pointer bg-[#A7AEBF] border-l-1 border-white">
